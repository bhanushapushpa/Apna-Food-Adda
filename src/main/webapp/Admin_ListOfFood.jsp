				...
				<table class="table table-striped table-hover table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=rs.getString("fcategory")%></td>
							<td><%=rs.getString("fdescription")%></td>
							<td ><img alt="" src="./Img/<%=rs.getString("fimg")%>"
								style="margin-left: 10px; margin-top: 10px; width: 100px; height: 50px;">
							</td>
							<td><a href="Admin_EditFood.jsp?id=<%=rs.getString("id")%>">Edit</a></td>
							<td><a href="Admin_DeleteFood.jsp?id=<%=rs.getString("id")%>">Delete</a></td>
