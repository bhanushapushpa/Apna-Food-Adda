		...
		<div class="flex-parent-element">
			<div class="flex-child-element magenta" style="border: none;">
				...
				<br> <img alt=""
					...
					style="border-radius: 200px; width: 6%;"><br>
			...
			<div class="flex-child-element magenta" style="border: none;">
				...
				<br>
				<br> <b>Address :</b> Niva Building Nagar,Near Vidya Hospital,<br>
				Gaon,Ghatkopar(W) - 401045 <br>
				<br> <b>Mobile No : </b>1234567890 <br>
				<br> <b>Email Id : </b>Data06@gmail.com
			</div>
		</div>
	</div>
